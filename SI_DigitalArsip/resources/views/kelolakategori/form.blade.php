                 ...
                 <form action="{{ route('kategori.store')}}" method="post">
                     ...
                     <div class="form-group">
                         ...
                         <input type="text" class="form-control" name="namakategori" id="namakategori"
                             aria-describedby="Nama Kategori" placeholder="Masukkan Nama" required>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="editForm" method="post">
                ...
                <div class="form-group">
                    <label for="namakategori">Nama Kategori</label>
                    <input type="text" class="form-control " name="namakategori" id="namakategori" placeholder="Masukkan Nama"
                        required>
                    <div id="kodeWarning" class="text-danger"></div>
                </div>
                <div class="form-group">
