                                    ...
                                    <tr class="odd">
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a type="button" href="/sub-kategori/edit/{{ $subkategoris->id }}" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Tombol Edit"><i class="fas fa-edit"></i></a>
                                                <a type="button" href="/sub-kategori/delete/{{ $subkategoris->id }}"class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Tombol Hapus"><i class="fas fa-trash-alt"></i></a>
                                            </div>
                                        </td>
